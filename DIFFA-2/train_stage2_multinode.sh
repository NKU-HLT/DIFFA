...
export NCCL_SOCKET_IFNAME=eth0  # 替换为实际网络接口
export NCCL_TREE_THRESHOLD=0
export NCCL_IB_TIMEOUT=22
export NCCL_IB_RETRY_CNT=7
export NCCL_DEBUG=INFO
export NCCL_DEBUG_SUBSYS=ALL
export NCCL_P2P_DISABLE=0        # 一般不用动，除非有特殊网络
export NCCL_NET_GDR_LEVEL=5      # 某些环境需要设置
...
overwrite_output_dir="True" # Important!
output_dir="/path/to/projects/DIFFA-exp/stage2" #stage1_1e-4_20_4_64gpu_warmup1000
train_dataset_path="/path/to/projects/DIFFA-data/sft/merged_data.json"
llm_model="/path/to/models/LLaDA-8B-Instruct"
whisper_model="/path/to/models/whisper-large-v3"


previours_ckpt="/path/to/projects/DIFFA-exp/stage1"
