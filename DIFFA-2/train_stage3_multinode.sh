...
output_dir="/path/to/projects/DIFFA-exp/stage3" 
train_dataset_path="/path/to/projects/DIFFA-data/stage3/merged_data.json"
llm_model="/path/to/models/LLaDA-8B-Instruct"
whisper_model="/path/to/models/whisper-large-v3"

previours_ckpt="/path/to/projects/DIFFA-exp/stage2"
